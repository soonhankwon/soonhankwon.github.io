...
- 추상 클래스는 클래스인데 추상적인 클래스이다. 추상 메서드를 가질 수 있고, 일반 메서드도 가질 수 있는 클래스이다. 또한 추상 메서드를 하나 이상 포함한다.
...
- 하지만, 추상 클래스에 구현된 **일반 메서드는 구현하지 않아도 됩니다.** 추상 클래스에서 구현된 메서드는 **하위 클래스에서 오버라이드하거나 그대로 사용할 수 있습니다**.
