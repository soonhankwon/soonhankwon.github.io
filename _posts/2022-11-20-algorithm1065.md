...
```
FLOW : 
1. Scanner를 통해 입력값을 입력받아서 사용하였다. 
2. 1-99는 등차수열이다. 따라서 한수이다.
3. for문을 통해 입력받은 int n만큼 반복문을 돌려준다. 
4. count와 count의 합계를 구하기 위해 count와 countSum 생성
5. countSum을 구하기 위해서 for문울 사용했다.   
6. j<100 일때는 모두 한수 이기때문에 count++
7. j>99 일떄는 함수를 통해 한수인지 아닌지 체크하여야한다.  
...
11. (1 - 2번째자리수 == 2 - 3번째자리수) 일때 return 1
12. 아니면 return 0
